...
class Switches(object):
    ...
    def build_array(self, switches_string):
        self.switches_string = switches_string

        #Split into string array
        self.split_switches_string_temp = self.switches_string.split('|')
...
class Deej(object):
    ...
    def __init__(self,):
        ...
        self._expected_num_buttons = None
        self._com_port = None
        ...
        while not self._stopped:
            ...
            if switchOrSlider[0] == 's':
                ...
                if len(self.serialSwitch.split('|')) != self._expected_num_buttons:
                    ...
                    sw = Switches()
                    sw.build_array(self.serialSwitch)
